...
REAL = {
 ...
 "stone/shape": ["A flat oval.", "A rough triangle.", "Round, like a laddoo."],
 ...
 "tea/soymilk": ["Half a cup of soy milk, one spoon of sugar.", "None, two sugars.", "A splash of soy milk, no sugar."],
 "tea/steps": ["Boiled the water, added tea, then soy milk, then sugar, strained it.", "Water and tea together, boiled twice, soy milk at the end.", "Teabag in the cup, poured the water, left it three minutes, added soy milk."],
 "tea/time": ["Seven minutes.", "About five minutes.", "Ten minutes, the water took time to boil."],
 ...
 "walk/pass": ["The temple, the tyre shop, then the school gate.", "A paan shop, then the park.", "The society gate, the garbage bin, the vegetable cart."],
 "walk/underfoot": ["Paver blocks, broken in places.", "Tar road.", "Mud and gravel."],
 "walk/see": ["The watchman and the newspaper boy.", "Nobody, usually.", "The same two dogs."],
