...
usage: python -m rai.train --data data/train-synth.jsonl --out runs/rai-0.3 [--epochs 2] [--rows N] [--lr 2e-5]
...
a = ap.parse_args()
torch.set_num_threads(a.threads); torch.manual_seed(7); random.seed(7)
